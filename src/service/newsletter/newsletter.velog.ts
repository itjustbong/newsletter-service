...
export class VelogNewsletter {
  constructor(private mailer: iMailer, private crawler: iCrawler) {}

  async sendMail() {
    const orgHTML = await this.crawler.getHTML();
    const parsedHTML = this.crawler.parseHTML(orgHTML);
